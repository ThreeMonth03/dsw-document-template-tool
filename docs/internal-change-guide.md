...
| Science Europe sentence rewrite or branch-fragment cleanup | [`_template_transform/science_europe.py`][science-europe-py] | [`profile.py`][transform-profile-py], [`science_europe_balanced_rules.py`][science-europe-balanced-py], [`science_europe_unbalanced_rules.py`][science-europe-unbalanced-py], [`rewrite_rules.py`][rewrite-rules-py] | [`tests/unit/test_template_transform.py`][test-template-transform-py], [`tests/unit/test_rewrite_rules.py`][test-rewrite-rules-py], render regression |
...
| Translator-facing source-fragment regression guard | [`source_quality_rules.py`][source-quality-rules-py] | [`source_text.py`][source-text-py], [`tree_audit.py`][tree-audit-py] | [`tests/unit/test_source_quality_rules.py`][test-source-quality-rules-py], [`tests/unit/test_translation_tree.py`][test-translation-tree-py] |
| Exact-source synchronization between template versions | [`_translation_tree/merge.py`][tree-merge-py], [`translation_repository/`][translation-repository-py] | [`scripts/ci/create_translation_migration_prs.py`][migration-prs-py], [`scripts/ci/check_translation_migration_status.py`][migration-status-py] | [`tests/unit/test_translation_tree.py`][test-translation-tree-py], [`tests/infra/test_translation_migration_prs.py`][test-migration-prs-py] |
| Read-only wording consistency across version branches | [`translation_repository/consistency.py`][translation-consistency-py] | [`scripts/ci/report_translation_consistency.py`][translation-consistency-report-py] | [`tests/unit/test_translation_consistency.py`][test-translation-consistency-py] |
| Downstream `sync/v*` branch refresh | [`scripts/ci/sync_translation_version_branches.py`][sync-version-branches-py] | [`examples/github-actions/document_template_translation_sync.yml`][translation-sync-workflow] and version policy config | [`tests/infra/test_translation_version_branch_sync.py`][test-version-branch-sync-py], [`tests/infra/test_github_workflows.py`][test-github-workflows-py] |
...
| Render preview or regression behavior | [`workflow.py`][workflow-py], [`render_project.py`][render-project-py] | [`_regression/`][regression-dir], [`api.py`][api-py], [`fixture_generator.py`][fixture-generator-py], [`html_diff.py`][html-diff-py] | [`tests/unit/test_workflow.py`][test-workflow-py], [`tests/unit/test_regression_artifacts.py`][test-regression-artifacts-py], [`tests/unit/test_render_project.py`][test-render-project-py], [`tests/unit/test_fixture_generator.py`][test-fixture-generator-py] |
...
[regression-dir]: https://github.com/ThreeMonth03/dsw-document-template-tool/tree/master/src/dsw_document_template_tool/_regression
...
[source-quality-rules-py]: https://github.com/ThreeMonth03/dsw-document-template-tool/blob/master/src/dsw_document_template_tool/_translation_tree/source_quality_rules.py
[source-text-py]: https://github.com/ThreeMonth03/dsw-document-template-tool/blob/master/src/dsw_document_template_tool/_translation_tree/source_text.py
...
[test-regression-artifacts-py]: https://github.com/ThreeMonth03/dsw-document-template-tool/blob/master/tests/unit/test_regression_artifacts.py
...
[test-source-quality-rules-py]: https://github.com/ThreeMonth03/dsw-document-template-tool/blob/master/tests/unit/test_source_quality_rules.py
...
[test-translation-consistency-py]: https://github.com/ThreeMonth03/dsw-document-template-tool/blob/master/tests/unit/test_translation_consistency.py
...
[transform-profile-py]: https://github.com/ThreeMonth03/dsw-document-template-tool/blob/master/src/dsw_document_template_tool/_template_transform/profile.py
[translation-repository-py]: https://github.com/ThreeMonth03/dsw-document-template-tool/tree/master/src/dsw_document_template_tool/translation_repository
[translation-consistency-py]: https://github.com/ThreeMonth03/dsw-document-template-tool/blob/master/src/dsw_document_template_tool/translation_repository/consistency.py
[translation-consistency-report-py]: https://github.com/ThreeMonth03/dsw-document-template-tool/blob/master/scripts/ci/report_translation_consistency.py
