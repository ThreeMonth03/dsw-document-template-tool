# Translation Repository Notes

Use these notes for repository operation:
...
```text
https://www.threemonth03.com/dsw-document-template-tool/
```

These files were copied from the tool repository template under
`examples/translation-repository/`. Keep local project-specific policy in this
repository after copying.
